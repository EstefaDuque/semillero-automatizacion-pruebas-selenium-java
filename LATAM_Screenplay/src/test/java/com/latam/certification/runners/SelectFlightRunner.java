...
@CucumberOptions(
		...
		//Ruta del feature
		features = "src/test/resources/features/select_flight.feature",
		...
		plugin= {"pretty",
				"json:target/json-report/selectFlightReport.json",
				"html:target/selectFlight-html-report",
				"junit:target/xml-report/selectFlight.xml"},
