...
public class SearchFlightComponent {
	...
	public static final Target CHILDREN_BABIES = Target.the("link more children or babies").located(By.xpath("//div[@class='box-component passenger-count col-xs-12 col-md-12 active']//div[@class='box-panel shadow-box spinners col-xs-12 col-sm-12']//div//a[@class='link-children-or-babies'][contains(text(),'Añadir niños o bebés')]"));
