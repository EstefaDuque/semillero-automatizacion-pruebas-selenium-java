$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/features/buy_flight.feature");
formatter.feature({
  "name": "Buy a flight in latam",
...
formatter.background({
  "name": "Successful Login in Latam to look for flights in Latam and select and random flight in latam",
  "description": "",
  "keyword": "Background"
});
formatter.before({
...
formatter.step({
  "name": "she selects the payment method",
  "rows": [
    {
      "cells": [
        "paymentMethod"
...
formatter.match({
  "location": "BuyFlightStepDefinitions.sheSelectsThePaymentMethod(BuyData\u003e)"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "she will verify your reservation code",
  "keyword": "Then "
});
formatter.match({
  "location": "BuyFlightStepDefinitions.sheWillVerifyYourReservationCode()"
});
formatter.result({
  "status": "passed"
});
